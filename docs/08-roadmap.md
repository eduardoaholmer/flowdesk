...
### Sprint 17.1 — M6: transferência de propriedade de workspace (concluída, verificação parcial)
...
### Sprint 17.3 — M6: `MailSender` real (SMTP) (concluída, verificação parcial)
